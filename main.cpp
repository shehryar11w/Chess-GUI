...
float getXfromBoardPosition(char x) {
    x = x - 'a';
    // std::cout << (x) * 58.0f << "\n";
    return (x) * 61.0f - 5;  // Each square is 61 pixels wide
}

float getYfromBoardPosition(int y) {
    int rank = 9 - y;  // Convert chess rank (1-8) to board index (7-0)
    return (rank - 1) * 64.0f - 5;  // Each square is 61 pixels tall
}
...
int main()
{
    ...
    for (int i = 0; i < 8; ++i)
    {
        ...
        whitePawn.setPosition({getXfromBoardPosition('a' + i), getYfromBoardPosition(2)}); // Position at row 6 (white's pawns)
    ...
    for (int i = 0; i < 8; ++i)
    {
        ...
        blackPawn.setPosition({getXfromBoardPosition('a' + i), getYfromBoardPosition(7)}); // Position at row 1 (black's pawns)
        pieces.push_back(blackPawn);
    }

    // Place rooks
    sf::Sprite whiteRook1(whiteRookTexture), whiteRook2(whiteRookTexture);
    whiteRook1.setPosition({61.0f * 0, getYfromBoardPosition(1)}); // Position at (0, 7)
    whiteRook2.setPosition({61.0f * 7,getYfromBoardPosition(1)}); // Position at (7, 7)
    ...
    whiteKnight1.setPosition({61.0f * 1, getYfromBoardPosition(1)}); // Position at (1, 7)
    whiteKnight2.setPosition({61.0f * 6, getYfromBoardPosition(1)}); // Position at (6, 7)
    ...
    whiteBishop1.setPosition({61.0f * 2, getYfromBoardPosition(1)}); // Position at (2, 7)
    whiteBishop2.setPosition({61.0f * 5, getYfromBoardPosition(1)}); // Position at (5, 7)
    ...
    whiteQueen.setPosition({61.0f * 3, getYfromBoardPosition(1)}); // Position at (3, 7)
    ...
    whiteKing.setPosition({61.0f * 4, getYfromBoardPosition(1)}); // Position at (4, 7)
